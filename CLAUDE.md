...
Packaging/backups/Docker are still not started (no scope agreed yet). The security-hardening backlog that used to live here is done — see "Security hardening (2026-07-16)" above.
