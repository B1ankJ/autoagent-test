...
vi.mock('../api/config', () => ({
  ...
  useNotifications: () => ({ data: { enabled: false, webhook_url: '', secret: '', empty_response_threshold: 3, same_response_enabled: false, same_response_threshold: 3, at_mobiles: [], at_all: false } }),
